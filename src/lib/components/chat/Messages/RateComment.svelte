<script lang="ts">
	...
	function loadReasons() {
		...
		DISLIKE_REASONS = [
			'Nie podoba mi się styl',
			'Niepoprawne fakty',
			'Nie wykonał w pełni instrukcji',
			'Odmówił bez powodu',
			'Zbyt leniwy',
			'Inne'
		];
...
>
	<div class="flex justify-between items-center">
		<div class=" text-sm">{'Powiedz nam więcej:'}</div>
	...
	<div class="mt-2">
		<textarea
			...
			placeholder={'Możesz dodać szczegółowe informacje'}
			rows="2"
		/>
	</div>
