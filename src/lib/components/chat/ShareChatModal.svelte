...
<Modal bind:show size="sm">
	<div>
		<div class=" flex justify-between dark:text-gray-300 px-5 py-4">
			<div class=" text-lg font-medium self-center">{'Udostępnij czat'}</div>
			<button
				class="self-center"
				on:click={() => {
					show = false;
				...
				<div class="flex justify-end">
					<div class="flex flex-col items-end space-x-1 mt-1.5">
						<div class="flex gap-1">
							...
							>
								{'Dziel się z społecznością OpenWebUI'}
							</button>
							...
							<button
								...
								on:click={async () => {
									...
									toast.success('Skopiowano URL udostępnionego czatu do schowka!');
									show = false;
								}}
							>
								<Link />
