...
const GITHUB_TOOLS = [
	{ type: 'function', function: { name: 'gh_whoami', description: 'Pobiera informacje o zalogowanym użytkowniku GitHub', parameters: { type: 'object', properties: {} } } },
	{ type: 'function', function: { name: 'gh_list_repos', description: 'Listuje repozytoria użytkownika GitHub', parameters: { type: 'object', properties: { type: { type: 'string', enum: ['all', 'public', 'private'], description: 'Typ repozytoriów' }, sort: { type: 'string', enum: ['updated', 'created', 'pushed', 'full_name'], description: 'Sortowanie' } } } } },
	{ type: 'function', function: { name: 'gh_create_repo', description: 'Tworzy nowe repozytorium GitHub', parameters: { type: 'object', properties: { name: { type: 'string', description: 'Nazwa repozytorium' }, description: { type: 'string', description: 'Opis repozytorium' }, private: { type: 'boolean', description: 'Czy repozytorium ma być prywatne' }, auto_init: { type: 'boolean', description: 'Czy inicjalizować z README' } }, required: ['name'] } } },
	{ type: 'function', function: { name: 'gh_edit_repo', description: 'Edytuje istniejące repozytorium (nazwa, opis, widoczność)', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Aktualna nazwa repo' }, name: { type: 'string', description: 'Nowa nazwa repo' }, description: { type: 'string', description: 'Nowy opis' }, private: { type: 'boolean', description: 'Prywatne/publiczne' } }, required: ['owner', 'repo'] } } },
	{ type: 'function', function: { name: 'gh_delete_repo', description: 'Usuwa repozytorium GitHub', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' } }, required: ['owner', 'repo'] } } },
	{ type: 'function', function: { name: 'gh_list_files', description: 'Listuje pliki i foldery w repozytorium', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' }, path: { type: 'string', description: 'Ścieżka w repo (puste = root)' }, ref: { type: 'string', description: 'Gałąź lub commit SHA' } }, required: ['owner', 'repo'] } } },
	{ type: 'function', function: { name: 'gh_read_file', description: 'Odczytuje zawartość pliku z repozytorium', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' }, path: { type: 'string', description: 'Ścieżka pliku' }, ref: { type: 'string', description: 'Gałąź lub commit SHA' } }, required: ['owner', 'repo', 'path'] } } },
	{ type: 'function', function: { name: 'gh_write_file', description: 'Tworzy lub aktualizuje plik w repozytorium (commit)', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' }, path: { type: 'string', description: 'Ścieżka pliku' }, content: { type: 'string', description: 'Zawartość pliku (tekst)' }, message: { type: 'string', description: 'Wiadomość commita' }, branch: { type: 'string', description: 'Gałąź (domyślnie main)' } }, required: ['owner', 'repo', 'path', 'content', 'message'] } } },
	{ type: 'function', function: { name: 'gh_delete_file', description: 'Usuwa plik z repozytorium', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' }, path: { type: 'string', description: 'Ścieżka pliku' }, message: { type: 'string', description: 'Wiadomość commita' }, branch: { type: 'string', description: 'Gałąź' } }, required: ['owner', 'repo', 'path', 'message'] } } },
	{ type: 'function', function: { name: 'gh_list_branches', description: 'Listuje gałęzie repozytorium', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' } }, required: ['owner', 'repo'] } } },
	{ type: 'function', function: { name: 'gh_create_branch', description: 'Tworzy nową gałąź w repozytorium', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' }, branch: { type: 'string', description: 'Nazwa nowej gałęzi' }, from_branch: { type: 'string', description: 'Bazowa gałąź (domyślnie main)' } }, required: ['owner', 'repo', 'branch'] } } },
	{ type: 'function', function: { name: 'gh_list_commits', description: 'Listuje commity w repozytorium', parameters: { type: 'object', properties: { owner: { type: 'string', description: 'Właściciel repo' }, repo: { type: 'string', description: 'Nazwa repo' }, branch: { type: 'string', description: 'Gałąź' }, per_page: { type: 'number', description: 'Liczba commitów (maks 100)' } }, required: ['owner', 'repo'] } } },
	{ type: 'function', function: { name: 'gh_search_repos', description: 'Wyszukuje repozytoria na GitHub', parameters: { type: 'object', properties: { query: { type: 'string', description: 'Fraza wyszukiwania' }, sort: { type: 'string', enum: ['stars', 'forks', 'updated'], description: 'Sortowanie wyników' } }, required: ['query'] } } }
];
